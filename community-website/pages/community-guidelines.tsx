      ...
      <main className={`${styles.communityGuidelines} text-black dark:text-white`}>
        ...
        <div>
          <p>
            ...
            We take pride in being inclusive and treating everyone with respect, regardless of gender identity and expression, sexual orientation, disabilities, neurodiversity, physical appearance, body size, ethnicity, nationality, race, age, religion, or similar personal characteristics. 
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                <li>&emsp; - Don&apos;t use violent threats or language directed against another individual.</li>
                <li>&emsp; - Consider collaboration before conflict.</li>
                <li>&emsp; - No discriminatory jokes, insults, and language. This includes discriminatory behavior and speech, especially racist, homophobic, sexist, or demeaning words.</li>
                <li>&emsp; - Do not post sexually explicit or violent material.</li>
            ...
            <li>
              ...
              <br/>
              <p>
                Suppose a community member engages in unacceptable behavior. 
                In that case, the community maintainers may take any action they deem appropriate, including a temporary ban or permanent expulsion from the community without warning (and without refund in the case of a paid event).
              </p>
            </li>
            <br/>
            <li>
              ...
              <p>
                Written by: {" "} 
                  <a href="https://github.com/Bennykillua"
                    target="_blank" 
                    rel="noopener noreferrer"
                    style={{ color: "#0070F3"}}
                  >
