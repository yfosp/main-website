...
[https://github.com/Your-First-Open-Source-Project/Hacktoberfest2022](https://github.com/Your-First-Open-Source-Project/Hacktoberfest2022)
...
```markdown
git clone https://github.com/Your-First-Open-Source-Project/Hacktoberfest2022
```
...
// GITHUB: https://github.com/Prakhar9450

console.log('Hello, World!');
```

Name the file `hello_world_yourusername.xx`. e.g., `hello_world_Prakhar_Pathak.js` or `hello_world_Prakhar_Pathak.py`.
...
- Check out our [CONTRIBUTERS](./CONTRIBUTORS.md) for more information.
